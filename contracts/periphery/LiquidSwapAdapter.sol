...
contract LiquidSwapAdapter is ReentrancyGuard, Ownable {
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        address to,
        address, //referrer; mapped to feeRecipient, but hardcoded to owner() in this implementation
        uint deadline
        ...
        require(
            lastUpdateBlock[tokenIn][tokenOut] == block.number,
            "Swapper: path not set in this block"
        );
        ...
        liquidSwapRouter.executeSwaps(
            ...
            amountIn,
            amountOutMin,
            amountOutMin, // expectedAmountOut - using same as minAmountOut
            hops,
            0, // feeBps - setting to 0 for no additional fees
            owner() // feeRecipient - hardcoded to owner
        );
        ...
        require(
            ...
            "Swapper: minAmountOut > balanceOut"
        );
